...
Ce support de cours, largement nourri de productions de [Datactivist](open.datactivist.coop), est librement réutilisable selon les termes de la licence [Creative Commons 4.0 BY-SA](https://creativecommons.org/licenses/by-sa/4.0/legalcode.fr).
...
---
background-image: url("./img/trumpdata.png")
...
* Connaître le cadre juridique de l'ouverture des données
* Comprendre la place de l’ouverture des données dans la modernisation de l’État
* Comprendre l'importance des politiques d'ouverture des données pour la démocratie française contemporaine

---
### Plan du cours

1. Origines et principes de l'open data (aujourd'hui)
2. L'open data en pratique (le 6 février matin)
3. De la transparence à l'IA : défis contemporains de la régulation des données (le 6 février après midi)
...
* Connaître les origines historiques de l’ouverture des données
* Connaître les grands principes de l’ouverture des données
* Connaître les grandes lignes du cadre juridique de l’ouverture des données, de la loi CADA à la loi pour une République numérique
...
![](img/chrono.png)
[(Autre version, plus détaillée)](https://cdn.knightlab.com/libs/timeline3/latest/embed/index.html?source=1V00vQN4c23p_Z0EUOsedYAs4-Z37GNskVafUYhQ_v4Q&font=Default&lang=fr&hash_bookmark=true&initial_zoom=5&height=650#event-archives-et-open-data)
...
Je n'indique ici que quelques éléments généraux sur le cadre juridique, ce guide constitue votre source de référence. J'en ai publié une [fiche de lecture](https://teamopendata.org/t/guide-commun-cnil-et-cada-open-data-rgpd/1320) sur TeamOpenData.

Ce guide a été élargi en 2024 par des [éléments plus précis sur l'ouverture des données personnelles](https://www.cnil.fr/fr/ouverture-et-reutilisation-de-donnees-personnelles-sur-internet-la-cnil-publie-ses-recommandations).
...
La notation RTI (Right to information) est le principal outil mondial pour évaluer la solidité des cadres juridiques nationaux d'accès aux informations détenues par les autorités publiques (ou le droit à l'information, RTI). Il est largement utilisé par les organisations intergouvernementales, les défenseurs de la RTI, les réformateurs, les législateurs et autres.

---
### Les conditions d'exercice du droit d'accès

.red[ Une définition très large des documents administratifs]
> Les documents administratifs peuvent revêtir de nombreuses formes (dossiers, rapports, études, comptes rendus, procès-verbaux, statistiques, directives, instructions, circulaires, codes sources, .red[données], etc.) et adopter tout support (écrit, enregistrement sonore ou visuel, forme numérique ou informatique). 

Le droit d'accès s'appplique aux documents administratifs produits dans le cadre d'une .red[mission de service public] ie :
> Une mission d'intérêt général sous le contrôle de l'administration et qui est dotée à cette fin de prérogatives de puissance publique et est chargée de l'exécution d'un service public. 
...
3. les documents explicitement visés par [l’article D312-3-1 du CRPA](https://www.legifrance.gouv.fr/affichTexte.do;jsessionid=51E99AF738C12521572D6A7F6C8C03E8.tplgfr23s_1?cidTexte=JORFTEXT000037797147&dateTexte=&oldAction=rechJO&categorieLien=id&idJO=JORFCONT000037796937)
...
À l'heure actuelle il n'existe plus de licence ayant fait l'objet d'une homologation spécifique.
...
Arpentage du livre *Les données de la démocratie* de Samuel Goëta :
chacun lit un chapitre (à partir de "Le long chemin en France vers l’ouverture des données par défaut") et en prépare une discussion. 
...
## Les acteurs
  - Dinum / Etalab
  - réseau des AMDAC
  - ANCT et réseau des chargés de mission numérique des SGAR
  - collectivités territoriales
  - CADA
  - régulateurs sectoriels (exemple : ART pour les dispositions de la loi LOM)
...
---
## Les réutilisateurs 
  - entreprises (dont services numériques)
  - associations
  - citoyens
  - administrations
...
# De la transparence à l'IA

## Défis contemporains de la régulation des données

---

## Enjeux de l'ouverture des données

- ouverture par défaut, orientée par la demande ou par un objectif ("publishing with purpose") ?
- stratégie transversale ou sectorielle ?
- comment garantir la qualité des données ?
- ouverture, publication, partage... ?
- quels modèles économiques de l'ouverture des données ?

---

## Quelques autres enjeux de régulation des données

- le Data Governance Act 
  - services d'intermédiation des données (ex : AgDataHub)
  - altruisme de données 
- l'AI Act
  - souligne la nécessité d'une transparence et d'une gouvernance des données utilisées dans le cadre de SIA
  - intervention des régulateurs (CNIL, mais aussi DGCCRF et Défenseur des droits)
- La construction d'une expertise technique publique (ex : PEREN)
